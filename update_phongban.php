 ...
 * Truy cập qua trình duyệt: http://your-domain/quanLyChamCong/update_phongban.php
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td>" . htmlspecialchars($oldDept) . "</td>";
    echo "<td><strong>" . htmlspecialchars($newDept) . "</strong></td>";
...
<div class="warning">
    <strong>⚠️ Hãy xóa file <code>update_phongban.php</code> sau khi chạy xong!</strong>
</div>
